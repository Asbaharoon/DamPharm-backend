...
//		builder.setReplacedElementFactory(new B64ImgReplacedElementFactory());
	...
	public void parseTemplate(String cTemplate, HttpServletResponse response) throws Exception {
		OutputStream outputStream = response.getOutputStream();
		String style = getTagValues(cTemplate);
...
//				+ " line-height: 14px;" + "}" + "blockquote p {" + "  display: inline;" + "}"
				+ "</style></head><body>" + cTemplate.replace(style, "") + "</body></html>";
