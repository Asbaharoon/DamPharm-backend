...
public class SwaggerConfig {
	...
	public Docket swaggerSpringfoxDocket() {
		...
		Contact contact = new Contact("Salah Atwa", "https://www.linkedin.com/in/ssatwa/", "salahsayedatwa@gmail.com");

		List<VendorExtension> vext = new ArrayList<>();
		ApiInfo apiInfo = new ApiInfo("Backend API", "This is the best stuff since sliced bread - API", "6.6.6",
				"https://www.linkedin.com/in/mustafamym/", contact, "MIT", "https://www.linkedin.com/in/mustafamym/",
				vext);
		...
		docket = docket.select().paths(regex(DEFAULT_INCLUDE_PATTERN)).build()
				.ignoredParameterTypes(UserPrinciple.class);
		return docket;
	}
